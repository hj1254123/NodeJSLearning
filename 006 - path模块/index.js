...
path.basename('C:/temp/myfile.html') // 'myfile'
...
// 8.返回 path 的目录名
path.dirname('/home/bin/1.txt') // /home/bin

// 9.返回 path 的扩展名
path.extname('/home/bin/1.txt') // .txt
...
// 11. path.isAbsolute() 方法检测 path 是否为绝对路径。
// POSIX
